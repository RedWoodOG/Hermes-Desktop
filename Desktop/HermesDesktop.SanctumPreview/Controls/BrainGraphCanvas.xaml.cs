...
public sealed partial class BrainGraphCanvas : UserControl
{
    ...
    private void DrawEdge(Microsoft.Graphics.Canvas.CanvasDrawingSession ds, BrainNode a, BrainNode b, BrainEdge edge, float cx, float cy)
    {
    ...
    private void DrawNode(Microsoft.Graphics.Canvas.CanvasDrawingSession ds, BrainNode node, float cx, float cy)
    {
    ...
    private void DrawParticle(Microsoft.Graphics.Canvas.CanvasDrawingSession ds, BrainNode a, BrainNode b, BrainEdge edge, float cx, float cy)
    {
